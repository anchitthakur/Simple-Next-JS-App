...
var ApiPages = function ApiPages(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    if (!props.isFetched) ApiPages.getInitialProps({
      page: props.page,
      search: props.search,
      flag: 1
    }).then(function (json) {
      return setData(json.data);
    });else if (!mounted.current) mounted.current = true;else ApiPages.getInitialProps({
      page: props.page,
      search: props.search,
      flag: 1
    }).then(function (json) {
...
//# sourceMappingURL=ApiPages.js.fd2ea397b7667924d923.hot-update.js.map