...
function Api(props) {
  if (Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(props.posts).length == 0) props.fetchPosts({
      page: props.page,
      search: props.search
    });
  }, [])) ;else Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    props.fetchPosts({
      page: props.page,
      search: props.search
    });
...
//# sourceMappingURL=apipages.js.cea4b46245023220198e.hot-update.js.map